...
<body>
	<form method="post"   action="${contextPath}/member/insertMembers.do">
	...
	<table class="memberTable" align="center">
	   ...
	   <tr>
	    ...
	    <tr>
	       ...
	       <td width="200"><p><input type="text" name="email"></td>
	    </tr>
	    <tr>
	       <td width="100"><p>&nbsp;</p></td>
	       <td width="200"><input type="submit" value="가입하기" style="margin-right : 5px;">
